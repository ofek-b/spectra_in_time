...
def manual_clustering():
    ...
    clusters = dict(
        ...
        main_IIb=['SN2011hs', 'SN2011dh', 'SN2006T', 'SN2008bo', 'SN2013df', 'SN2011fu', 'SN1993J', 'SN2011ei',
                  'SN2016gkg', 'SN2008ax'],
        ...
        rest_IIb=['SN2017gpn', 'SN1996cb', 'SN2006el'], )

    showmean2(snlist, X_PC, TIME, LAMB, dlog=True, names=clusters['main_IIb'], label='Main Cluster IIb',
              cnames=clusters['rest_IIb'], clabel='Offset Cluster IIb', speclines=False)
    showmean2(snlist, X_PC, TIME, LAMB, dlog=False, names=clusters['main_IIb'], label='Main Cluster IIb',
              cnames=clusters['rest_IIb'], clabel='Offset Cluster IIb', speclines=False)
