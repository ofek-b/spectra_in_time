...
def manual_clustering():
    ...
    clusters = dict(
        ...
        main_Ib=['SN2007Y', 'SN2006ep', 'SN2015ah', 'SN1999dn', 'iPTF13bvn', 'SN2005hg', 'SN2009iz'],
        ...
        rest_Ib=['SN2004gq', 'SN2015ap', 'SN2004gv', 'SN2007uy', 'SN2016jdw', 'SN2017bgu', 'SN2004dk'], )
    ...
    showmean(snlist, X_PC, TIME, LAMB, names=clusters['main_Ib'], label='Lower Cluster Ib', comp_name='SN2016jdw',
             speclines=False)
    showmean(snlist, X_PC, TIME, LAMB, names=clusters['rest_Ib'], label='Upper Cluster Ib', comp_name='iPTF13bvn',
             speclines=False)
