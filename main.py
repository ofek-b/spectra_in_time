...
sfpctgs = None  # for showing superfit sizes in the graph set to not None
...
myscatter(dismat_emb, snlist, save_html=False, legend=False, sfpctgs=sfpctgs)  # 2D or 3D scatter plot
